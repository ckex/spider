...
public class YyUserCallRecordHistoryDo implements Serializable {
  ...
  public String toString() {
    return "YyUserCallRecordHistoryDo[id=" + id + ", userId=" + userId + ", name=" + name + ", number=" + number + ", type=" + type + ", callTime="
        + callTime + ", duration=" + duration + ", createTime=" + createTime + ", updateTime=" + updateTime + "]";
  }
}

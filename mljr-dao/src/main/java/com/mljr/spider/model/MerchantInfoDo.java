...
public class MerchantInfoDo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (mmId != null ? !mmId.equals(that.mmId) : that.mmId != null) return false;
        ...
        if (mmBussinessLicense != null ? !mmBussinessLicense.equals(that.mmBussinessLicense) : that.mmBussinessLicense != null)
            return false;
        if (mmPersonName != null ? !mmPersonName.equals(that.mmPersonName) : that.mmPersonName != null) return false;

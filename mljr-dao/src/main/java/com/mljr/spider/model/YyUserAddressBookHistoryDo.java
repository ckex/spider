...
public class YyUserAddressBookHistoryDo implements Serializable {
  ...
  public String toString() {
    return "YyUserAddressBookHistoryDo[id=" + id + ", userId=" + userId + ", name=" + name + ", company=" + company + ", number=" + number
        + ", homeAddress=" + homeAddress + ", email=" + email + ", relationship=" + relationship + ", nickName=" + nickName + ", createTime="

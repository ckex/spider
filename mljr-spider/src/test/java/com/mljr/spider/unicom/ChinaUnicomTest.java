...
public class ChinaUnicomTest {
  ...
  private String loginUrl =
      "https://uac.10010.com/portal/Service/MallLogin?callback=jQuery17202691898950318097_1403425938090&redirectURL=http%3A%2F%2Fwww.10010.com&userName="
  ...
  private CloseableHttpClient httpclient = HttpClients.custom().setDefaultCookieStore(cookieStore).setDefaultRequestConfig(globalConfig).build();
  ...
  private void run() throws ClientProtocolException, Exception {
    ...
    if (loginEntityContent.contains("resultCode:\"0000\"")) {
      ...
      String subUrl =
          "http://iservice.10010.com/e3/static/query/searchPerInfo/?_=1485076150761&accessURL=http://iservice.10010.com/e4/query/basic/personal_xx_iframe.html";

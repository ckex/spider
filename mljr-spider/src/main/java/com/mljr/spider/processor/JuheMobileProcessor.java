...
public class JuheMobileProcessor extends AbstractPageProcessor {
  ...
  private static Site site = Site.me().setDomain("juhe.cn").setSleepTime(10).setRetryTimes(2).setRetrySleepTime(500).setCharset(UTF_8)
      .addHeader("Content-Type", "application/json;charset=" + UTF_8);

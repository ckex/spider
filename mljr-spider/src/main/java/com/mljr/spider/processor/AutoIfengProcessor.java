...
public class AutoIfengProcessor extends AbstractPageProcessor {
  ...
  private static final Site site = Site.me().setDomain(DomainConstant.DOMAIN_AUTOIFENG).setSleepTime(1000).setRetrySleepTime(4200).setRetryTimes(2)
  ...
  public static void main(String[] args) throws Exception {
    Spider.create(new AutoIfengProcessor()).addPipeline(new LocalFilePipeline("/data/autoifeng")).addUrl(START_URL).start();
  }
}

...
public class Auto163Processor extends AbstractPageProcessor {
  ...
  private static Site site = Site.me().setDomain("auto.163.com").setSleepTime(300).setRetrySleepTime(2000).setRetryTimes(3)
  ...
  public static void main(String[] args) throws Exception {
    Spider spider = Spider.create(new Auto163Processor()).setPipelines(Lists.newArrayList(new FilePipeline("/data/html")));
  ...
  public static final ThreadPoolExecutor DEFAULT_THREAD_POOL =
      new ThreadPoolExecutor(25, 25, 100, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(10), new ThreadFactory() {

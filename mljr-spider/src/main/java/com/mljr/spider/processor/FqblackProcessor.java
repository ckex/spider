...
public class FqblackProcessor extends AbstractPageProcessor {
  ...
  private final static Site site = Site.me().setDomain("fqblack.com").addHeader("Accept", "application/json, text/plain, */*").setRetrySleepTime(3000)
      .setRetryTimes(3).setUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:50.0) Gecko/20100101 Firefox/50.0");
  ...
  public static void main(String[] args) {
    Spider.create(new FqblackProcessor())
        .addUrl(
            "http://www.fqblack.com/index/index.html?blackQuery.keyword=%E5%88%98%E9%9B%AA%E8%8E%B2&blackQuery.pageNo=1&blackQuery.pageTotal=2&blackQuery.type=1")

...
public class QichachaProcessor extends AbstractPageProcessor {
  ...
  private static Site site = Site.me().setDomain("qichacha.com").setRetrySleepTime(1500).setRetryTimes(3)
  ...
  public static void main(String[] args) {
    Spider.create(new QichachaProcessor()).addUrl("http://www.qichacha.com/firm_2abadeb7044eed1a17f3202940308109.shtml")
        .addUrl("http://www.qichacha.com/firm_a0bd2d9eb184996fcb42c722534c6993").addPipeline(new ConsolePipeline())
        .addPipeline(new LocalFilePipeline("/data/html")).run();
  }
}

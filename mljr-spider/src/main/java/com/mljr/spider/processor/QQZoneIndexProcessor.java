...
/**
 * Created by gaoxi on 2017/1/5. QQ空间首页解析
 */
public class QQZoneIndexProcessor extends AbstractPageProcessor {

  private Site site = Site.me().setDomain("qqzone.index").setSleepTime(2000).setRetrySleepTime(3000).setRetryTimes(3);
  ...
  private String extract(String str) {
    String jsonp =
        str.replace("<html><head></head><body><pre style=\"word-wrap: break-word; white-space: pre-wrap;\">", "").replace("</pre></body></html>", "");

...
public class CarHomeProcessor extends AbstractPageProcessor {
  ...
  // 给site赋值
  private static final Site site = Site.me().setDomain("car.autohome.com.cn").setSleepTime(1000).setRetrySleepTime(1000).setCharset("utf-8")
      .setRetryTimes(3).setUserAgent(USER_AGENT);

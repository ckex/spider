 ...
 */
public class YinHangKa388Scheduler extends AbstractScheduler {

  private static final String URL = "http://yinhangka.388g.com/?cid=%s";

  public YinHangKa388Scheduler(Spider spider, BlockingQueue<UMQMessage> mqMsgQueue) throws Exception {
    super(spider, mqMsgQueue);
  }

  public YinHangKa388Scheduler(Spider spider, AbstractMessage.PullMsgTask task) throws Exception {
    super(spider, task);
  }

  public YinHangKa388Scheduler(Spider spider, String qid) throws Exception {
    super(spider, qid);
  }

...
public abstract class AbstractMessage {
  ...
  public static final ThreadPoolExecutor DEFAULT_THREAD_POOL =
      new ThreadPoolExecutor(CORE_SIZE, MAX_SIZE, 100, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(10), new ThreadFactory() {
  ...
  protected static final ThreadPoolExecutor newThreadPool(int coreSize, int maxSize, final String tname) {
    return new ThreadPoolExecutor(coreSize, maxSize, 100, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(10), new ThreadFactory() {

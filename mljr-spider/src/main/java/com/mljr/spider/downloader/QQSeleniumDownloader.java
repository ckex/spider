...
public class QQSeleniumDownloader extends AbstractDownloader {
  ...
  public Page download(Request request, Task task) {
    ...
    String url = request.getUrl().replace(QQUtils.QQ_LOGIN, paramsMap.get(QQUtils.QQ_LOGIN).toString()).replace(QQUtils.QQ_P_SKY,
        paramsMap.get(QQUtils.QQ_P_SKY).toString());

...
public class AsyncHttpClient {
  ...
  public AsyncHttpClient() throws IOReactorException {
    ...
    IOReactorConfig ioReactorConfig = IOReactorConfig.custom().setConnectTimeout(connectTimeout).setSoKeepAlive(true).setSoTimeout(socketTimeout)
        .setSelectInterval(selectInterval).setTcpNoDelay(tcpNoDelay).build();
    ...
    httpclient = HttpAsyncClients.custom().setConnectionManager(connManager).setDefaultRequestConfig(defaultReqConfig).setUserAgent("mljr-spider")

 ...
 */
@Service
public class MCurrentFlowSelectorServiceImpl extends AbstractRequestUrlSelectorService {
  ...
  public List<RequestInfoDTO> getRequestUrl(RequestUrlDTO requestUrl, Date filterDate) {
    ...
    list.add(convert(requestUrl.getMobile(), requestUrl.getIdcard(), datePair, getUrl(datePair)));
  ...
  protected OperatorsUrlEnum getOperatorsUrl() {
    return OperatorsUrlEnum.CHINA_MOBILE_CURRENT_FLOW;
  }

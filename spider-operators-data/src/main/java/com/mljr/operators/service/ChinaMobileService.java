...
//    }
    ...
    // 04 网络流量信息
    public String getFlowBill(Map<String, String> cookies, DatePair pair) throws Exception {
    ...
    // 05 短信使用信息
    public String getSmsBill(Map<String, String> cookies, DatePair pair) throws Exception {
    ...
    // 06 通话详单
    public String getCallBill(Map<String, String> cookies, DatePair pair) throws Exception {

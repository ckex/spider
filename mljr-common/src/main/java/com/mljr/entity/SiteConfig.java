...
//        siteConfig.setDomain("163.com");
     ...
     * Because urls are more a Spider's property than MySite, move it to {@link Spider#addUrl(String...)}}
     *
    ...
    /**
     * Add a url to start url.<br>
     * Because urls are more a Spider's property than MySite, move it to {@link Spider#addRequest(Request...)}}
     *

...
public class MonitorData implements Serializable {
  ...
  public double getParseSuccessRate() {
    ...
    BigDecimal result = new BigDecimal((freq200 - freqParseFail) * 100).divide(new BigDecimal(freq200), 2, BigDecimal.ROUND_HALF_EVEN);
  ...
  public String toString() {
    return "MonitorData [time=" + time + ", domain=" + domain + ", serverIp=" + serverIp + ", totalRequests=" + totalRequests + ", statusCodes="
        + statusCodes + ", freq200=" + freq200 + ", freq301=" + freq301 + ", freq302=" + freq302 + ", freq304=" + freq304 + ", freq307=" + freq307
        + ", freq401=" + freq401 + ", freq403=" + freq403 + ", freq404=" + freq404 + ", freq500=" + freq500 + ", freq501=" + freq501 + ", freq504="
        + freq504 + ", freqParseFail=" + freqParseFail + ", onErrorCount=" + onErrorCount + ", onSuccessCount=" + onSuccessCount + ", successRate="
        + successRate + ", parseSuccessRate=" + parseSuccessRate + ", diffTime=" + diffTime + "]";
  }
